...
$w = date('w', strtotime($date));
	...
	elseif ($date >= '2014-12-15' && $date <= '2014-12-19') {$libhours = "8am - 4pm"; $bg='#5cb85c !important';}
	elseif ($date >= '2014-12-20' && $date <= '2015-01-04') {$libhours = "CLOSED"; $bg='#e2e2d4 !important';}
	elseif ($date >= '2015-01-05' && $date <= '2015-01-24') {
		if ($date == '2015-01-10' || $date == '2015-01-11' || $date == '2015-01-24') {$libhours = "1pm - 5pm"; $bg = '#5cb85c !important';}
		elseif ($w == 0) {$libhours = "CLOSED"; $bg='#e2e2d4 !important';}
		else {$libhours = "8am - 4pm"; $bg = '#5cb85c !important';}
	}
